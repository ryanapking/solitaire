...
const cards = [
  ...
  new Card("club", "J", CJ, "black"),
  new Card("club", "Q", CQ, "black"),
  new Card("club", "K", CK, "black"),

  new Card("spade", "A", SA, "black"),
  ...
  new Card("spade", "J", SJ, "black"),
  new Card("spade", "Q", SQ, "black"),
  new Card("spade", "K", SK, "black"),

  new Card("heart", "A", HA, "red"),
  ...
  new Card("heart", "J", HJ, "red"),
  new Card("heart", "Q", HQ, "red"),
  new Card("heart", "K", HK, "red"),
  
  new Card("diamond", "A", DA, "red"),
  ...
  new Card("diamond", "J", DJ, "red"),
  new Card("diamond", "Q", DQ, "red"),
  new Card("diamond", "K", DK, "red")
]
